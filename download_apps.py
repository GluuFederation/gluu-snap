...
if not '-e' in sys.argv:
    ...
    download('https://ox.gluu.org/npm/passport/passport-{}.tgz'.format(app_versions['PASSPORT_VERSION']), 'passport/passport.tgz')
    ...
    download('https://ox.gluu.org/maven/org/gluu/oxd-server/{0}{1}/oxd-server-{0}{1}-distribution.zip'.format(app_versions['OXD_SERVER_VERSION'], app_versions['OX_GITVERISON']), 'oxd-server/oxd-server.zip')
