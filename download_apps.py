...
if not '-e' in sys.argv:
    ...
    download('https://ox.gluu.org/maven/org/gluu/oxShibbolethStatic/{0}{1}/oxShibbolethStatic-{0}{1}.jar'.format(app_versions['OPENDJ_VERSION'], app_versions['OX_GITVERISON']), 'idp/shibboleth-idp.jar')
